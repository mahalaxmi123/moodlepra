...
$html = theme_design_get_html_for_settings($OUTPUT, $PAGE);
    ...
    <?php echo $OUTPUT->standard_top_of_body_html() ?>
        ...
        <div id="page-wrapper">
            <div id="header-wrapper">
                ...
                <header role="banner" class="navbar navbar-fixed<?php echo $html->navbarclass ?> moodle-has-zindex">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="nav-collapse collapse">
                                ...
                                <ul class="nav pull-right">
                                    ...
                                    <div class="span4 headerlinks-box">
                                        <!-- Start Social Icons -->
