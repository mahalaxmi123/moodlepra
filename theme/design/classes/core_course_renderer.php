...
class theme_design_core_course_renderer extends core_course_renderer {
   ...
   /**
    ...
    protected function coursecat_coursebox_fa(coursecat_helper $chelper, $course, $additionalclasses = '') {
        ...
        $classes = trim('course-box span4 panel clearfix '. $additionalclasses);
        $nametag = 'h4';
        ...
        $content .= html_writer::start_tag('div', array('class' => 'flip content'));
		...
		$content .= html_writer::end_tag('div'); // .panel-body
		
        $content .= html_writer::end_tag('div'); // .flip content
    ...
    protected function coursecat_coursebox_content_fa(coursecat_helper $chelper, $course) {
        ...
        if ($course->has_summary()) {
            ...
            if (strlen($summurytext) >= 300) {
                $content .= html_writer::tag('div', substr($summurytext, 0, 250).'...', array('class'=>'summary-box'));
            } else {
