...
This document describes how to copy and customise the Practice (bootstrapbase) theme so that
...
From your Moodle theme directory right click on practice and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of practice.
...
underscores. For the purpose of this tutorial we will call the theme 'practicetheme'.

On opening 'practicetheme' your you will find several files and sub-directories which have
files within them.
...
where the old theme name occurs, in this case practice. So using the above list as
a guide, search through and change all the instances of the theme name
'practice' to 'practicetheme'. This includes the filename of the lang/en/theme_practice.php.
You need to change this to 'theme_practicetheme.php'.
...
and then click on (Practicetheme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the Practice theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > Practice

Moodle documentation
--------------------

Further information can be found on Moodle Docs: http://docs.moodle.org/dev/Practice_theme
